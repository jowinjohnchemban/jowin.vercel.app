...
const envSchema = z.object({
  ...
  NEXT_PUBLIC_SITE_DESCRIPTION: z.string().optional().describe('Site description'),

  // Hashnode Configuration
  NEXT_PUBLIC_HASHNODE_PUBLICATION_ID: z.string().optional(),
  HASHNODE_API_KEY: z.string().optional().describe('Hashnode API key for blog data'),
  ...
  CONTACT_EMAIL: z.string().email().optional().describe('Destination for contact form'),
  RESEND_FROM_EMAIL: z.string().email().optional().describe('From email for Resend'),
  ...
  // Analytics
  NEXT_PUBLIC_GTM_ID: z.string().optional().describe('Google Tag Manager ID'),
  NEXT_PUBLIC_AHREFS_KEY: z.string().optional().describe('Ahrefs verification key'),
  NEXT_PUBLIC_GOOGLE_SITE_VERIFICATION: z.string().optional(),
  NEXT_PUBLIC_DMCA_VERIFICATION: z.string().optional(),
